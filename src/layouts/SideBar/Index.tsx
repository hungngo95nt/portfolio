...
const SideBar = () =>{
  return (
    <div className='fixed inset-0 h-full bg-gray-50 z-90 w-full border-b -mb-16 lg:-mb-0 lg:static lg:h-auto lg:overflow-y-visible lg:border-b-0 lg:pt-0 lg:w-1/4 lg:block lg:border-0 xl:w-1/5 hidden pt-16'>
      <div id='navWrapper' className='h-full overflow-y-auto scrolling-touch lg:h-auto lg:block lg:relative lg:sticky lg:bg-transparent overflow-hidden lg:top-16 bg-gray-50'>
      <aside id="sidebar-multi-level-sidebar" className="overflow-y-auto text-base lg:text-sm sticky?lg:h-(screen-16)" aria-label="Sidebar">
